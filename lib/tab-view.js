	...
	render: function() {
		return (
			<div className="tabsAndPanels clearfix">
				...
				<TabPanels deletePanel={ this.props.deletePanel } removeQuestion={ this.props.removeQuestion } selected={ this.state && this.state.selected } tabPanels={ this.props.tabPanels } />
			</div>
		);
	}
